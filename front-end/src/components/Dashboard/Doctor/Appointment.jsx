...
const Appointment = ({ appointment, loading, error }) => {
              ...
              <tr key={item._id}>
                ...
                >
                  ...
                  <div className="flex justify-center items-center gap-x-10">
                    <img src={item?.user.photo} alt="" className="w-[100px] rounded-lg" />
                    <div>
                      <h3>
                        <span className="font-semibold">Name:</span> {item?.userData.name}
                      </h3>
                      <h3>
                        <span className="font-semibold">Email:</span> {item?.userData.email}
                      </h3>
                      <h3>
                        <span className="font-semibold">Phone:</span> {item?.userData.phone}
                      </h3>
                      <h3>
                        <span className="font-semibold">Blood Type:</span> {item?.user.bloodType}
                      </h3>
