            ...
            <div>
              <div className="lg:w-[570px]">
                ...
                <p className="text__para">
                  Lorem ipsum dolor sit amet consectetur adipisicing elit. Velit asperiores quos
                  inventore, adipisci debitis excepturi doloribus. Ratione minima necessitatibus,
                  facere error itaque sapiente, natus, ab nostrum fugit iste nemo ducimus.
                </p>
                <Link to="/doctors">
                  <button className="btn hover:opacity-80">Request an Appointment</button>
                </Link>
              </div>
            ...
            <div className="py-[30px] px-5">
              ...
              <div className="mt-[30px]">
                ...
                <p className="text-[16px] leading-7 text-textColor font-[400] mt-4 text-center">
                  Wold-class care for everyone. Our health System offers unmatched, expert health
        ...
        <div className="container">
          <div className="flex items-center justify-between flex-col lg:flex-row">
            <div className="xl:w-[670px]">
              ...
              <Link to="/">
                <button className="btn hover:opacity-80">Learn More</button>
              </Link>
            </div>
